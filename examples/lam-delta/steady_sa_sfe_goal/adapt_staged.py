...
cur_dir = os.getcwd()
print(cur_dir)
pbs.profile_filename = f'{cur_dir}/fun3d_intg_modules.sh'
pbs.mpiexec = 'mpiexec_mpt'

initial_complexity = 16000
...
adapt_driver.simulation = SimulationFun3dSFEAdjoint(
    project, fwd_omp_threads=1, adj_omp_threads=8, external_wall_distance=False)
