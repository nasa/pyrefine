...
def arg_parser():
    ...
    parser.add_argument("--input_file", default="sfe.cfg",
                        help="Input SFE configuration file with deprecated parameter names.")
    parser.add_argument("--output_file", default="sfe.cfg",
                        help="Output SFE configuration file with current parameter names.")
    return parser
